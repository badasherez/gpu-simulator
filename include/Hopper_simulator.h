#ifndef HOPPER_SIMULATOR_H
#define HOPPER_SIMULATOR_H
...
/**
 * @brief Hopper GPU Simulator class
 * 
 * This class simulates the Hopper GPU architecture for floating-point operations
 * using the Gfloat format.
 */
class Hopper_simulator {
public:
    // Constructor
    Hopper_simulator();

    // Destructor
    ~Hopper_simulator() = default;
