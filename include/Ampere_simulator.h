#ifndef AMPERE_SIMULATOR_H
#define AMPERE_SIMULATOR_H
...
/**
 * @brief Ampere GPU Simulator class
 * 
 * This class simulates the Ampere GPU architecture for floating-point operations
 * using the Gfloat format.
 */
class Ampere_simulator {
public:
    // Constructor
    Ampere_simulator();

    // Destructor
    ~Ampere_simulator() = default;
